-- Cria bucket no Storage para comprovantes de entrega
-- e configura politicas RLS

-- 1. Cria bucket para comprovantes (idempotente)
...
-- 2. Politicas RLS para o bucket de comprovantes
